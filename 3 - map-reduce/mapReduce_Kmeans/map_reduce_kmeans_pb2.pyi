...
class MapRequest(_message.Message):
    __slots__ = ("inputStartIndex", "inputEndIndex", "centroids", "numReducers")
    ...
    numReducers: int
    def __init__(self, inputStartIndex: _Optional[int] = ..., inputEndIndex: _Optional[int] = ..., centroids: _Optional[_Iterable[_Union[Data, _Mapping]]] = ..., numReducers: _Optional[int] = ...) -> None: ...
...
class ReduceInputReply(_message.Message):
    __slots__ = ("data",)
    DATA_FIELD_NUMBER: _ClassVar[int]
